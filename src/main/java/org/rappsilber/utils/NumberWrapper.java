 ...
 * <p>Also updating a number that is stored as e.g. the value of an HashMap is
 * rather complicated with Numeric types as this requires to store a new values 
 * instead of just updating</p>
